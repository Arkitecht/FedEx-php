...
class RadioactiveContainerClassType
{
     ...
     * @uses self::VALUE_INDUSTRIAL_IP1
     * @uses self::VALUE_INDUSTRIAL_IP2
     * @uses self::VALUE_INDUSTRIAL_IP3
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_INDUSTRIAL_IP1,
            self::VALUE_INDUSTRIAL_IP2,
            self::VALUE_INDUSTRIAL_IP3,
            self::VALUE_TYPE_A,
            self::VALUE_TYPE_B_M,
            self::VALUE_TYPE_B_U,
            self::VALUE_TYPE_C,
