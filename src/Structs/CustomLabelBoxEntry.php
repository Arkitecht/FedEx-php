...
class CustomLabelBoxEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\Arkitecht\FedEx\Structs\CustomLabelPosition $topLeftCorner = null, \Arkitecht\FedEx\Structs\CustomLabelPosition $bottomRightCorner = null)
    {
        $this
     ...
     * @param \Arkitecht\FedEx\Structs\CustomLabelPosition $topLeftCorner
     * @return \Arkitecht\FedEx\Structs\CustomLabelBoxEntry
     */
