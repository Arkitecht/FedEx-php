...
class ShipmentLegRateDetail extends AbstractStructBase
{
     ...
     * @param \Arkitecht\FedEx\Structs\Address $legOrigin
     * @param string $legOriginLocationId
     * @param \Arkitecht\FedEx\Structs\Address $legDestination
     ...
     */
    public function __construct($legDescription = null, \Arkitecht\FedEx\Structs\Address $legOrigin = null, $legOriginLocationId = null, \Arkitecht\FedEx\Structs\Address $legDestination = null, $legDestinationLocationId = null, $rateType = null, $rateScale = null, $rateZone = null, $pricingCode = null, $ratedWeightMethod = null, $minimumChargeType = null, \Arkitecht\FedEx\Structs\CurrencyExchangeRate $currencyExchangeRate = null, $specialRatingApplied = null, $dimDivisor = null, $dimDivisorType = null, $fuelSurchargePercent = null, \Arkitecht\FedEx\Structs\Weight $totalBillingWeight = null, \Arkitecht\FedEx\Structs\Weight $totalDimWeight = null, \Arkitecht\FedEx\Structs\Money $totalBaseCharge = null, \Arkitecht\FedEx\Structs\Money $totalFreightDiscounts = null, \Arkitecht\FedEx\Structs\Money $totalNetFreight = null, \Arkitecht\FedEx\Structs\Money $totalSurcharges = null, \Arkitecht\FedEx\Structs\Money $totalNetFedExCharge = null, \Arkitecht\FedEx\Structs\Money $totalTaxes = null, \Arkitecht\FedEx\Structs\Money $totalNetCharge = null, \Arkitecht\FedEx\Structs\Money $totalRebates = null, \Arkitecht\FedEx\Structs\Money $totalDutiesAndTaxes = null, \Arkitecht\FedEx\Structs\Money $totalNetChargeWithDutiesAndTaxes = null, \Arkitecht\FedEx\Structs\FreightRateDetail $freightRateDetail = null, \Arkitecht\FedEx\Structs\RateDiscount $freightDiscounts = null, \Arkitecht\FedEx\Structs\Rebate $rebates = null, \Arkitecht\FedEx\Structs\Surcharge $surcharges = null, \Arkitecht\FedEx\Structs\Tax $taxes = null, \Arkitecht\FedEx\Structs\EdtCommodityTax $dutiesAndTaxes = null, \Arkitecht\FedEx\Structs\VariableHandlingCharges $variableHandlingCharges = null, \Arkitecht\FedEx\Structs\VariableHandlingCharges $totalVariableHandlingCharges = null)
    {
        $this
     ...
     * @param string $legDescription
     * @return \Arkitecht\FedEx\Structs\ShipmentLegRateDetail
     */
     ...
     * @return \Arkitecht\FedEx\Structs\ShipmentLegRateDetail
     */
    public function setLegOrigin(\Arkitecht\FedEx\Structs\Address $legOrigin = null)
    {
     ...
     * @return \Arkitecht\FedEx\Structs\ShipmentLegRateDetail
     */
    public function setLegDestination(\Arkitecht\FedEx\Structs\Address $legDestination = null)
    {
