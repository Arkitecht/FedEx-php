...
class ExportDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Arkitecht\FedEx\Structs\DestinationControlDetail
     */
     ...
     * @param \Arkitecht\FedEx\Structs\DestinationControlDetail
     * $destinationControlDetail
     */
    public function __construct($b13AFilingOption = null, $exportComplianceStatement = null, $permitNumber = null, \Arkitecht\FedEx\Structs\DestinationControlDetail $destinationControlDetail = null)
    {
        $this
     ...
     * @uses \Arkitecht\FedEx\Enums\B13AFilingOptionType::valueIsValid()
     * @uses \Arkitecht\FedEx\Enums\B13AFilingOptionType::getValidValues()
     * @param string $b13AFilingOption
     * @return \Arkitecht\FedEx\Structs\ExportDetail
     */
    public function setB13AFilingOption($b13AFilingOption = null)
    {
        if (!\Arkitecht\FedEx\Enums\B13AFilingOptionType::valueIsValid($b13AFilingOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $b13AFilingOption, implode(', ', \Arkitecht\FedEx\Enums\B13AFilingOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \Arkitecht\FedEx\Structs\DestinationControlDetail|null
     */
     ...
     * @return \Arkitecht\FedEx\Structs\ExportDetail
     */
    public function setDestinationControlDetail(\Arkitecht\FedEx\Structs\DestinationControlDetail $destinationControlDetail = null)
    {
