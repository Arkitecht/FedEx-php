...
class VariableHandlingChargeDetail extends AbstractStructBase
{
     ...
     * @param \Arkitecht\FedEx\Structs\Money $fixedValue
     * @param decimal $percentValue
     * @param string $rateElementBasis
     * @param string $rateTypeBasis
     */
    public function __construct(\Arkitecht\FedEx\Structs\Money $fixedValue = null, $percentValue = null, $rateElementBasis = null, $rateTypeBasis = null)
    {
        $this
     ...
     * @param \Arkitecht\FedEx\Structs\Money $fixedValue
     * @return \Arkitecht\FedEx\Structs\VariableHandlingChargeDetail
     */
    public function setFixedValue(\Arkitecht\FedEx\Structs\Money $fixedValue = null)
    {
     ...
     * @uses \Arkitecht\FedEx\Enums\RateElementBasisType::valueIsValid()
     * @uses \Arkitecht\FedEx\Enums\RateElementBasisType::getValidValues()
     * @param string $rateElementBasis
     * @return \Arkitecht\FedEx\Structs\VariableHandlingChargeDetail
     */
    public function setRateElementBasis($rateElementBasis = null)
    {
        if (!\Arkitecht\FedEx\Enums\RateElementBasisType::valueIsValid($rateElementBasis)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rateElementBasis, implode(', ', \Arkitecht\FedEx\Enums\RateElementBasisType::getValidValues())), __LINE__);
        }
